...
public class Login extends javax.swing.JFrame {
    ...
    public Login(String centralServer) {
    ...
    public void fetchClients() {
        ...
        try{
            ...
            String urlstr = "http://" + centralServer + ":8084/CentralServlets/GetClientDB";
            ...
            clientDB = (UserDB)in.readObject();
            in.close();
            fetched = true;
            for(int i=0;i<clientDB.list.size();i++) {
                jComboClients.addItem(clientDB.list.get(i).userID + " - " + clientDB.list.get(i).userName);
            }
        }catch(Exception e) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jLabel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE))
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPasswordField1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 262, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jLabel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
...
// TODO add your handling code here:
        ...
        if(clientDB.list.get(index).password.equals(pass)) {
            setVisible(false);
            new MainForm(clientDB.list.get(index), centralServer).setVisible(true);
            return;
        }else {
            attempts++;
        ...
        if(attempts == 3) {
            new MessageBox(this, "Maximum Attempts Reached!").setVisible(true);
            System.exit(0);
        }
