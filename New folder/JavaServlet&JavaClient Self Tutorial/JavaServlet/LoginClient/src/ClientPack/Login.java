...
public class Login extends javax.swing.JFrame {
    ...
    public void callServlet() {
        String idpassword = jTextField1.getText() + "," + new String(jPasswordField1.getPassword());


        try {
            String urlstr = "http://localhost:8084/LoginServer//LoginServlet";
